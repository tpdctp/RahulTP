...
$expected_header_1 = 'expected_value_1';
$expected_header_2 = 'expected_value_2';

// Check if headers are present and match expected values
if (!isset($_SERVER['HTTP_DHruv_Capitan_Header_1']) || $_SERVER['HTTP_DHruv_Capitan_Header_1'] !== $expected_header_1 ||
    !isset($_SERVER['HTTP_DHruv_Capitan_Header_2']) || $_SERVER['HTTP_DHruv_Capitan_Header_2'] !== $expected_header_2) {
